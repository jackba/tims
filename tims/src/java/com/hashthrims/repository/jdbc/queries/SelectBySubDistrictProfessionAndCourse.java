 ...
 * @author boniface
 */
public class SelectBySubDistrictProfessionAndCourse extends MappingSqlQuery<PeopleReport> {
    ...
    public SelectBySubDistrictProfessionAndCourse(DataSource dataSource) {
