 ...
 * @author boniface
 */
public class SelectByCityProfessionalAndCourse extends MappingSqlQuery<PeopleReport> {
    ...
    public SelectByCityProfessionalAndCourse(DataSource dataSource) {
        ...
        super.declareParameter(new SqlParameter("name", Types.BIGINT));
