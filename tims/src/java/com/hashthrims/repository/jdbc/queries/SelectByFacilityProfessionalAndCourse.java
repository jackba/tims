 ...
 * @author boniface
 */
public class SelectByFacilityProfessionalAndCourse extends MappingSqlQuery<PeopleReport> {
    ...
    public SelectByFacilityProfessionalAndCourse(DataSource dataSource) {
