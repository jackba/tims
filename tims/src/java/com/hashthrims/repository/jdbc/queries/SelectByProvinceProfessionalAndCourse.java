 ...
 * @author boniface
 */
public class SelectByProvinceProfessionalAndCourse extends MappingSqlQuery<PeopleReport> {
    ...
    public SelectByProvinceProfessionalAndCourse(DataSource dataSource) {
