 ...
 * @author boniface
 */
public class SelectByDistrictProfessionalAndCourse extends MappingSqlQuery<PeopleReport> {
    ...
    private static final String SQL_STATEMENT = " "
            ...
            + "AND scheduledcourses.courseid = :coursename "
            + "AND jobs.id = :jobtittle "
            + "AND county.id = :districtname "
            + "AND  employeecourses.coursestartdate BETWEEN :coursestartdate AND :courseenddate ";

    public SelectByDistrictProfessionalAndCourse(DataSource dataSource) {
        ...
        super.declareParameter(new SqlParameter("districtname", Types.BIGINT));
        super.declareParameter(new SqlParameter("jobtittle", Types.BIGINT));
        super.declareParameter(new SqlParameter("coursename", Types.BIGINT));
