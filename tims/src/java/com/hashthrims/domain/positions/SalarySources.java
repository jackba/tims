 ...
 */
@Entity
public class SalarySources implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SalarySources)) {
            return false;
        }
        SalarySources other = (SalarySources) object;
    ...
    public String toString() {
        return "com.hashthrims.domain.positions.SalarySources[id=" + id + "]";
    }
