 ...
 */
@Entity
public class GlobalPositions implements Serializable,Comparable<GlobalPositions> {
    ...
    private List<GlobalPositions> subodinates;
    @ManyToOne
    private GlobalPositions supervisor;
    @OneToOne
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GlobalPositions)) {
            return false;
        }
        GlobalPositions other = (GlobalPositions) object;
     ...
     */
    public List<GlobalPositions> getSubodinates() {
        return subodinates;
    }
     ...
     */
    public void setSubodinates(List<GlobalPositions> subodinates) {
     ...
     */
    public GlobalPositions getSupervisor() {
        return supervisor;
    }
     ...
     */
    public void setSupervisor(GlobalPositions supervisor) {
        this.supervisor = supervisor;
    }

    @Override
    public int compareTo(GlobalPositions o) {
