 ...
 */
package com.hashthrims.clients.web.vaadin.views.nimart.mentors.views;
 ...
 * @author boniface
 */
public class AssignMenteesViewPage extends VerticalLayout implements
    ...
    public AssignMenteesViewPage(HashThrimsMain app) {
        main = app;
        setSizeFull();
        pform = new UsersForm();
