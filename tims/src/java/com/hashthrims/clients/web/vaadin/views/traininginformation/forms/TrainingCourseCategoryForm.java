 ...
 * @author boniface
 */
public class TrainingCourseCategoryForm {
    ...
    public TrainingCourseCategoryForm() {
    }

    public Form createTrainingCourseCategoryForm() {
        Form form = new Form();
        form.setCaption("Training Field");
    ...
    static class CityFieldFactory extends DefaultFieldFactory {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if ("courseCatergory".equals(propertyId)) {
                field = new TextField("Training Field:");
                ((TextField) field).setColumns(30);
                ((TextField) field).setNullRepresentation("");
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Please Enter Value");
            } else if ("categoryId".equals(propertyId)) {
                field = new TextField("Category ID:");
