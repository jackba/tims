 ...
 * @author boniface
 */
public class MentoringAreasListTypeForm {
  ...
  // Define Buttons
    ...
    public MentoringAreasListTypeForm() {
    }

    public Form createMentoringAreasListForm() {
        final Form form = new Form();
        form.setCaption("Areas of Strengthening");
    ...
    static class MentoringSessionTypeFieldFactory extends DefaultFieldFactory {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            }if ("areasOfStrenthening".equals(propertyId)) {
                field = new TextField("Areas of Mentoring:");
