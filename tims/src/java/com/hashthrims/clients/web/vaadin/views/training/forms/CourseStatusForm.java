...
public class CourseStatusForm {
    ...
    public CourseStatusForm() {
    }

    public Form createCourseStatusForm() {
        Form form = new Form();
        form.setCaption("Course Status");
    ...
    static class CityFieldFactory extends DefaultFieldFactory {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if ("statusId".equals(propertyId)) {
                field = new TextField("Status ID:");
                ((TextField) field).setVisible(false);

            }
            if ("statusName".equals(propertyId)) {
                field = new TextField("course status Name:");
                ((TextField) field).setColumns(30);
                ((TextField) field).setNullRepresentation("");
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Please Enter Course Status Name");
            } 
      return field;
