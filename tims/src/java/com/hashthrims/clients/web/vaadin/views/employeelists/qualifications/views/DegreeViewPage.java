 ...
 * @author boniface
 */
public class DegreeViewPage extends VerticalLayout implements
    ...
    public DegreeViewPage(HashThrimsMain app) {
        main = app;
        setSizeFull();
    ...
    public void valueChange(ValueChangeEvent event) {
        ...
        if (property == table) {
            ...
            deg.setDegreeName(record.getItemProperty("Degree Name").toString());
            deg.setEducType(record.getItemProperty("Education Type").toString());
    ...
    public void buttonClick(ClickEvent event) {
        ...
        EmployeeListMenuView.qualSate = "DEGREE";
