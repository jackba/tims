 ...
 */
package com.hashthrims.clients.web.vaadin.views.reports.facilities;
 ...
 * @author boniface
 */
public class FacilitiesReportsMenuView extends VerticalLayout {

    private HashThrimsMain main;
    private TabSheet tab;
    private EmployeesTable empTable;

    public FacilitiesReportsMenuView(HashThrimsMain app, String selectedTab) {
        main = app;
