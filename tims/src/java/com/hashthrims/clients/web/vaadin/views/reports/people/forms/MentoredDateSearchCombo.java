 ...
 * @author boniface
 */
public class MentoredDateSearchCombo extends VerticalLayout {
    ...
    public MentoredDateSearchCombo() {
        setSizeFull();
        ...
        Label mentoringSubjectArea = new Label("Mentoring Subject Area : ");

        topicLayot.addComponent(positionLabel);
        topicLayot.addComponent(positionsCombo);
        topicLayot.addComponent(mentoringSubjectArea);
