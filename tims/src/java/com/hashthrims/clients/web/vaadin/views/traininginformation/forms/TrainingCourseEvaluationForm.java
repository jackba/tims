 ...
 * @author boniface
 */
public class TrainingCourseEvaluationForm {
    ...
    public Form createTrainingCourseEvaluationForm() {
        Form form = new Form();
        form.setCaption("Evaluations");
    ...
    public List orderList() {
        ...
        order.add("courseEvaluationName");           
        return order;
    }
    ...
    static class CityFieldFactory extends DefaultFieldFactory {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if ("courseEvaluationName".equals(propertyId)) {
                field = new TextField("Evaluation Name:");
                ((TextField) field).setColumns(30);
                ((TextField) field).setNullRepresentation("");
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Enter Value:");

            } else if ("courseEvaluationId".equals(propertyId)) {
                field = new TextField("Course Evaluation ID:");
