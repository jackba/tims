 ...
 * @author boniface
 */
public class TrainingInstitutionForm {
   ...
   private static ClientDataService data = new ClientDataService();
    ...
    public TrainingInstitutionForm() {
     ...
     public Form createTrainingInstitutionFrom() {
        Form form = new TrainingInstitutionGridForm();
        form.setImmediate(false);
        form.setFormFieldFactory(new TrainingInstitutionFieldFactory());
    ...
    class TrainingInstitutionFieldFactory extends DefaultFieldFactory implements Property.ValueChangeListener {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if ("institutionId".equals(propertyId)) {
                field = new TextField("TrainingInstitution ID:");
                ((TextField) field).setVisible(false);
            } else if ("institutionName".equals(propertyId)) {
                field = new TextField("Training Institution Name :");
          
                ((TextField) field).setColumns(20);
                ((TextField) field).setNullRepresentation("");
    
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Please Enter TrainingInstitution Name");
               ...
               if (dt != null) {
                ...
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Please Enter TrainingInstitution Code");
    ...
    class TrainingInstitutionGridForm extends Form {

        private GridLayout layout;

        public TrainingInstitutionGridForm() {
            setCaption("Training Institution Form");
            ...
            Label firstHeaderlabel = new Label("Training Institution Name");
        ...
        protected void attachField(Object propertyId, Field field) {
            ...
            if (propertyId.equals("institutionName")) {
                layout.addComponent(field, 0, 1);
            } else if (propertyId.equals("institutionId")) {
