 ...
 */
package com.hashthrims.clients.web.vaadin.views.nimart.data.views;
 ...
 * @author boniface
 */
public class CategoryViewPage extends VerticalLayout implements
    ...
    public CategoryViewPage(HashThrimsMain app) {
        main = app;
        setSizeFull();
        pform = new UsersForm();
