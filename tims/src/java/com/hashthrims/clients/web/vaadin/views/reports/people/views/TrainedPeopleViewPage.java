 ...
 * @author boniface
 */
public class TrainedPeopleViewPage extends VerticalLayout implements
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if (source == dateSearchCombo.getSearchButton()) {
            ...
            if (dateSearchCombo.getStartDate().getValue() == null || dateSearchCombo.getEndDate().getValue() == null) {
                main.mainView.getWindow().showNotification("Start and End Dates ", "Enter Start and End Dates ", Notification.TYPE_ERROR_MESSAGE);
            } else {
