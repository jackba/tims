 ...
 * @author boniface
 */
public class PositionGridForm extends Form {

    private final GridLayout layout;

    public PositionGridForm() {
        ...
        final Label firstHeaderlabel = new Label("Facility  Position");
