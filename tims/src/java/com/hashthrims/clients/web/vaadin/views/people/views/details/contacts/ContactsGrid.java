 ...
 * @author boniface
 */
public class ContactsGrid implements Button.ClickListener {
    ...
    public void addContacts(Person person, GridLayout layout, HashThrimsMain app) throws OverlapsException, OutOfBoundsException {
        ...
        contctactInfoLabel.addStyleName(Reindeer.LAYOUT_BLUE);
