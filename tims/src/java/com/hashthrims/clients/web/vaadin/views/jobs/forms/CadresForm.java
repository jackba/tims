...
public class CadresForm {
    ...
    public Form createCadreFrom() {
       final  Form form = new Form();
        form.setCaption("Cadres");
        form.setImmediate(false);
        form.setFormFieldFactory(new CadresFieldFactory());
    ...
    static class CadresFieldFactory extends DefaultFieldFactory {
