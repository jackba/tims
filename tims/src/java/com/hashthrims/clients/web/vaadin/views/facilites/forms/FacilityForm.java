...
public class FacilityForm {
    ...
    public Form createFacilityFrom() {
        final Form form = new FacilityGridForm();
        form.setImmediate(false);
        form.setFormFieldFactory(new FacilityFieldFactory());
    ...
    class FacilityFieldFactory extends DefaultFieldFactory implements Property.ValueChangeListener {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if ("facilityId".equals(propertyId)) {
                field = new TextField("Facility ID:");
                ((TextField) field).setVisible(false);
            } else if ("facilityName".equals(propertyId)) {
                field = new TextField("Facility Name:");
          
                ((TextField) field).setColumns(20);
                ((TextField) field).setNullRepresentation("");
           
                ((TextField) field).setRequired(true);
                ((TextField) field).setRequiredError("Please Enter Facility Name");
            } else if ("facilityTypeName".equals(propertyId)) {
                List<FacilityType> facilitytypes = data.getFacilityTypeService().findAll();
                selectFacilityType = new Select("Facility Type");
                for (FacilityType facilitytype : facilitytypes) {
                    selectFacilityType.addItem(facilitytype.getFacilityName());
                }
                selectFacilityType.setNewItemsAllowed(true);
                ...
                selectCountry.setNewItemsAllowed(false);
                ...
                ((TextField) field).setRequired(false);
                ((TextField) field).setRequiredError("Please Enter Facility Code");
    ...
    class FacilityGridForm extends Form {

        private final GridLayout layout;

        public FacilityGridForm() {
            setCaption("Office/Facility/None Form");
            ...
            final Label firstHeaderlabel = new Label("Office/Facility/Node");
            ...
            final HorizontalLayout secondHeader = new HorizontalLayout();
            secondHeader.setSizeFull();
            secondHeader.setStyleName(Runo.LAYOUT_DARKER);
            final Label secondHeaderLabel = new Label("Contact Information");
        ...
        protected void attachField(Object propertyId, Field field) {
            ...
            if (propertyId.equals("facilityTypeName")) {
