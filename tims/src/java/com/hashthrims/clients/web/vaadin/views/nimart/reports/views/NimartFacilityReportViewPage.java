 ...
 */
package com.hashthrims.clients.web.vaadin.views.nimart.reports.views;
 ...
 * @author boniface
 */
public class NimartFacilityReportViewPage extends VerticalLayout implements
    ...
    public NimartFacilityReportViewPage(HashThrimsMain app) {
        main = app;
        setSizeFull();
        pform = new UsersForm();
