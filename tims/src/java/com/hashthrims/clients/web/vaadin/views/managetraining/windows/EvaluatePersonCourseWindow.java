 ...
 * @author boniface
 */
public class EvaluatePersonCourseWindow extends Window implements ClickListener {
    ...
    public EvaluatePersonCourseWindow(Person p, EvaluateddCourseBean bean, HashThrimsMain app) {
        main = app;
        person = p;
